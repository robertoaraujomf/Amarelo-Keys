...
deb:
	...
	@mkdir -p deb/amarelo-keys/usr/share/icons/hicolor/256x256/apps
	...
	@cp src/icons/app_icon.png deb/amarelo-keys/usr/share/icons/hicolor/256x256/apps/amarelo-keys.png
	...
	@echo "Version: 1.0.1" >> deb/amarelo-keys/DEBIAN/control
	...
	@dpkg-deb --build deb/amarelo-keys dist/amarelo-keys_1.0.1_all.deb
	@rm -rf deb
	@echo ""
	@echo "Package created: dist/amarelo-keys_1.0.1_all.deb"

clean:
	rm -f dist/amarelo-keys_*.deb
